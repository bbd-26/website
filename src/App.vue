...
/* --- 手機版專屬調整 (螢幕寬度小於 600px 時生效) --- */
@media (max-width: 600px) {
  /* 1. 調整 Step 2 & 3 的文字大小 */
  .question-text, .greeting-text {
    font-size: 1.8rem !important; /* 讓文字在手機上不會溢出 */
    padding: 0 20px;
    line-height: 1.4;
  }

  /* 2. 縮小信封比例 (原本 300px 對手機來說太大了) */
  .valentines {
  ...
  .front {
    border-right: 144px solid #f4978e !important;
  ...
  .front:before {
    border-left: 240px solid #f8ad9d !important;
  ...
  .card-up {
    transform: translateY(-90px) !important; /* 手機彈出的高度縮小一點 */
  }
